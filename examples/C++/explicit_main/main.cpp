...
PANTHEIOS_EXTERN_C PAN_CHAR_T const PANTHEIOS_FE_PROCESS_IDENTITY[] = PANTHEIOS_LITERAL_STRING("example.C++.main");
...
)
{
    ...
    return libCLImate_main_entry_point_Cpp(argc, argv, NULL);
}
